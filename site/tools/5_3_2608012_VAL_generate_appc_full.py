...
# ─────────────────────────────────────────────────────────────
# HELPER: build a standard α×g or α×k table with LaTeX headers
# ─────────────────────────────────────────────────────────────

def _build_pct_table(row_alpha_list, col_labels, data_dict, row_label='$\\alpha$ \\ $g$'):
    """Return markdown lines for a percentage table with LaTeX headers.
    data_dict maps alpha -> list of values (one per col).
    """
    lines = []

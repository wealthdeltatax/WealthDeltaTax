...
See: valuation architecture (VAL §7); mathematical validation (VAL.A §A); VAL.B (worked examples); behavioural robustness (BEHAV §3); Valuation Body governance (GOV §6.1).

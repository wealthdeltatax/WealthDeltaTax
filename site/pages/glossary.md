...
**Revenue equivalence**
The condition under which all systems are calibrated such that the expected tax collected equals the same target as a proportion of initial wealth — here, E[T] = 2% of $W_0$. → (WP §9), (WP §9.1), (WP §B), (WP §B.2), (FAL §4), (FAL §4.3), (FAL §13), (FAL §A), (LR.A §2), (LR.A §2.2), (LR.B §6), (GOV §7), (GOV §7.5), (RATES §10)

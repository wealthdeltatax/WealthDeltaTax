...
The following objections come up most often. Each has a direct answer in the research; the citations point to the papers where it is developed in full. If you are new to the proposal, [Welcome](index.html) first.

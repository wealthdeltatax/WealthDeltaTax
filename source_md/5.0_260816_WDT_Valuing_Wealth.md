...
| 1.3 | 07 July 2026 | Cross-reference corrections: GOV §9 to GOV §10 (purchase option, two occurrences in §11); GOV §8.3 to GOV §5.3. (public register, §9) |
| 1.4 | 16 July 2026 | Rates paper read-in: internal bibliography updated; §8.4 citation updated to RATES §4 / Appendix C.2 |
| 1.5 | 16 July 2026 | Cross-paper consistency updates; derivatives framing in §12.2 updated; §8.4 internal contradiction resolved; Conclusion §3 hedged to structural claim; em dashes removed; JUR label corrected |
| 1.6 | 16 July 2026 | Simulation recalibration read-in: Abstract, §1, §5.2, §5.3, §7.1, §7.4, and Conclusion updated to RATES-aligned parameters; earlier low-rate calibration figures replaced |
| 1.7 | 18 July 2026 | Coherence corrections: §1 sign error corrected; §7.1 expanded; §7.3 clarified; Table 7.1-2 overstatement row corrected; §8.1 stale cross-reference removed |
...
| 1.9 | 25 July 2026 | Purchase option redesigned to Route D auction mechanism following GOV v1.3 §10: §11 retitled and rewritten throughout; §4.3, §4.4, §5, §6.4, and §7.1 updated to auction language; Glossary entry for Soft basis reset updated |
| 2.0 | 25 July 2026 | Structural compression: §4 route specification blocks moved to VAL.A; §7.1 simulation figures replaced with VAL.A cross-reference; §8 compressed to single section; §10.2–10.4 mechanics trimmed; §11.2 Harberger comparison compressed with reference to LR §6; §12.1 reporting list moved to VAL.A; Route D event table moved to VAL.A; Figure references replaced with VAL.A citations; VAL.A and VAL.B references updated throughout |
...
| 2.2 | 3 August 2026 | 0.3 formatter pass (Step 3): §8.4 final sentence removed (pointer to VAL.A §G.1 deleted; content now in §8.4 main body) |
| 2.3 | 7 August 2026 | §7.3 prose updated: overstatement net-tax advantage qualified to mild overstatement (α ≤ ~1.5 at canonical parameters); aggressive overstatement identified as carrying a net cost at reference growth rate under k = 0.001; quantitative boundary cross-referenced to VAL.A §C.1. |
| 2.4 | 7 August 2026 | Plateau characterisation pass: Abstract updated (equilibrium characterisation added; stale §G reference removed); §5.2 overstatement paragraph updated (mild vs aggressive distinction; corridor and ceiling); §7.1 retitled and rewritten (equilibrium is mild overstatement, not honest declaration; forecast-independence of α ≈ 1.2–1.5 established; honest declaration reframed as zero-forecast-exposure baseline); §7.2 updated (non-monotonic/saturation language replaced with plateau characterisation); §7.3 rewritten (mild overstatement: permanent forecast-independent advantage; aggressive overstatement: growth corridor requirement and 12% ceiling; self-limiting mechanism). |
| 2.5 | 9 Aug 2026 | Rewrote Limitations, Figure 7.1 added to §7.1; declaration-zone prose added to §7.1 and Conclusion characterising the white zone (α = 0.8 to 1.5 at historical mean growth) as a design feature rather than an enforcement gap; Conclusion third paragraph revised to reflect tolerant-zone framing|
| 2.6 | 9 Aug 2026 | Figures 5.1, 5.2, 7.2, 7.3, 7.4, 7.5 inserted with bridging prose; §5 rate-curve introduction added before §5.1; §5.2 C.1 heatmap added with updated VAL.A cross-reference; §7.1 motivation-line explanation added; §7.1 C.1/absolute-scale caveat added; Fig 7.2 (equilibrium cost curve) added after Fig 7.1; §7.2 TW-gap-by-N figure (Fig 7.3) and understater-plateau figure (Fig 7.4) added; §7.3 overstatement-reversal figure (Fig 7.5) added. Updated Limitations section |
| 2.7 | 10 Aug 2026 | Updated Limitations |
| 2.8 | 13 Aug 2026 | Parameter update: τ₀ = 15% (was 14%), N = 32 (was 34). Figure 5.1 prose and caption updated. Figure 5.2, 7.2, 7.4, 7.5 captions updated (N = 32). §7.4 C.6 inline figures updated (α = 0.5: 92.84%; α = 0.1: 86.55%). |
| 2.9 | 15 Aug 2026 | Updated limitaitons and §9 |
...
References throughout this paper to §A through §F refer to sections of the mathematical and simulation companion (VAL.A): §A (mathematical model and propositions), §B (simulation methodology), §C (simulation tables), §D (mechanism cases), §E (route specification tables), and §F (annual reporting requirements). Worked examples tethered to this paper's five claims are in (VAL.B), with each example lettered §J through §N to match the claim it illustrates.
...
Because fungible assets can be fractionally transferred, the WDT can settle liabilities in kind by taking a proportional equity interest at the declared value. This property is the foundation of the self-balancing mechanism described in §5.
...
The Route D auction mechanism (§11) is the backstop for egregious self-declarations on Route D. It depends on occasional triggering for its deterrent effect and is not a routine enforcement tool.
...
At RATES-aligned parameters, the cost of misstatement is directionally consistent and economically material across the tested range. Declaration strategy differences across growth rates are in VAL.A §C.1; the interaction between k and terminal net worth across strategies is in VAL.A §C.5. Limitations are addressed in §7.4 and VAL.A §F.
...
![Figure 5.1: Marginal rate function $\tau$(W) at canonical parameters ($\tau_0$ = 15%, $\tau_m$ = 70%, W_min = £2m, k = 0.001). The reference point at $V_0$ = £20m sits on the flat lower portion of the logistic curve. The rate begins rising materially above approximately £200m net worth and approaches the ceiling at billion-pound scale.](../figures/val_fig_01_rate_function.png){width=100%}
...
![Figure 5.2: C.1 metric heatmap: lifetime net tax difference as a share of terminal wealth, across declaration ratio α (rows) and annual growth rate g (columns). Red = taxpayer pays more than honest declaration; blue = taxpayer pays less. N = 29, $V_0$ = £20m, k = 0.001. Source: VAL.A §C.1.](../figures/val_fig_02_c1_heatmap.png){width=100%}
...
![Figure 7.3: Terminal net worth gap relative to honest declaration, by holding period N, at historical mean growth rate g = 10.5%. Red lines: understater strategies (α = 0.1 to 0.8). Blue lines: overstater strategies (α = 1.2 to 2.0). $V_0$ = £20m, k = 0.001. Source: VAL.A §C.8.](../figures/val_fig_04_tw_gap_by_n.png){width=100%}
...
See §14.3 and §14.4 for the failure case and Route D entry basis vulnerability respectively.

...
| 1.5      | 21 July 2026  | Parameter framework revision: $\tau_prov$ and $\tau_h$ separated as distinct optimisation problems; §5.3 rewritten to ground $\tau_0$ floor in collection-security logic (not anti-arbitrage); §5.9 updated to distinguish $\tau_prov$ (administrative) from $\tau_h$ (mechanism design); §5.1 definitions and Glossary entries for $\tau_h$ updated; §9.2 rewritten accordingly; CORP.A §B.1 and §B.2 revised with full derivations; formatter pass |
| 1.6      | 31 July 2026  | Consistency pass against CORP.A v1.6: Glossary $\tau_h$ entry, §5.1 $\tau_h$ definition, §5.3 tranche-three paragraph, and §5.9 $\tau_h$ calibration paragraph all updated to reflect §B.2 revised framework — legal proportionality replaced throughout with [deterrence floor, $\tau_m$] calibration range and self-defeating litigation observation; §6 extended with cross-reference to CORP.A §F for non-corporate instrument classification |
| 1.7      | 3 August 2026 | Formatter pass: temporal artifact removed from §5.3 ("rather than anti-arbitrage logic"); AI tell removed from §5.9 ("$\tau_h$ is a different question" pivot sentence); §9.1 temporal artifact removed ("previously treated as open") and AI-tell elaboration tightened; §9.2 AI tell tightened (competing-objectives list replaced with calibration range statement); GOV parenthetical stripped from §9.2 final sentence |
| 1.8 | 5 Aug 2026 | Structural revision: §9 (Conclusion) split into §9 (Limitations and Required Further Work) and §10 (Conclusion); resolved-design inventory moved to conclusion body; open questions content separated into limitations section. No substantive changes. |
| 1.9 | 8 Aug 2026 | Rewrote Limitations |
| 2.0 | 8 Aug 2026 | §2 extended with CIT and dividend tax distortions argument; §4.1 extended with thin trading, suspension/delisting, and dual-class share design rules; §5.3 updated with facility optionality forward reference; new §6 (Corporate Equity Settlement Facility) added; existing §6–§9 renumbered §7–§10; §9 Governing Council calibration parameters updated; §10 Conclusion updated; cross-references corrected |
...
The paper proceeds as follows. §2 establishes why existing instruments are insufficient. §3 derives the corporate instrument from the WDT's individual-centred logic. §4 establishes the listed/private distinction and, in §4.1, sets out design rules for IPOs, mergers, buybacks, thin trading, suspension and delisting, and dual-class share structures. §5 specifies the levy in full: calculation, provisional levy, credit release, intermediary pass-through, and final settlement. §6 describes the corporate equity settlement facility available as an alternative to cash settlement of the provisional levy. §7 states the attribution test for institutional ownership. §8 addresses derivatives and synthetic exposure. §9 addresses limitations and required further work.
...
The provisional levy is ordinarily paid in cash. Any listed company may instead settle through the corporate equity settlement facility described in §6, transferring shares to the SWF in lieu of cash. Both routes discharge the provisional levy obligation on the same terms.
...
Tranche two covers identified intermediaries: holders whose identity is established at the company level but who hold on behalf of others. The corporation provisions at $\tau_0$ against this tranche. Whether an intermediary's tranche resolves toward pass-through or toward a final charge, determined by the attribution test in §6, does not change what the company pays at the company level. It determines whether a downstream recovery mechanism exists for that intermediary.
...
An identified intermediary appearing on the register pays $\tau_0$ as a provisional charge at the company level. Where the intermediary passes the attribution test in §6, it runs its own client-level reconciliation directly with the tax authority rather than via the company's settlement account.
...
Derivatives and synthetic exposure raise related questions, addressed in §7.
...
Every identified holder that holds shares on behalf of, or in a manner indirectly affecting, persons other than itself falls within tranche two of §5. The corporate instrument applies a single attribution test to all such holders: can the intermediary identify and attribute its underlying beneficiaries to a degree that supports individual WDT reconciliation? Where it can, downstream pass-through is available on the terms set out in §5.5. Where it cannot, either because the underlying claim is not a proportional, individually-assessable interest in specific shares, or because the intermediary lacks the information to identify who holds what, $\tau_0$ is final at the company level.
...
The exclusion of derivative holders from reconciliation is distinct from the attribution test applied to intermediaries in §7. An institution failing that test is excluded because the human claim behind its holding is too diffuse or contingent to reconcile against an individual liability, despite the institution holding real shares. A derivative holder has no position at the corporate level at all; the attribution test does not apply.
...
Two items remain. Valuation methodology for derivative positions for individual WDT purposes, particularly where no liquid secondary market exists, is assigned to (VAL). The disclosure problem for counterparties held through opaque OTC structures is the same disclosure and information-exchange problem that applies to unidentified beneficial ownership generally, handled through the tranche structure in §5 and not resolvable unilaterally.

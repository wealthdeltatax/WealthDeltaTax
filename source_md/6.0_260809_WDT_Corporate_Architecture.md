...
| 1.5      | 21 July 2026  | Parameter framework revision: $\tau_prov$ and $\tau_h$ separated as distinct optimisation problems; (CORP §5.3) rewritten to ground $\tau_0$ floor in collection-security logic (not anti-arbitrage); (CORP §5.9) updated to distinguish $\tau_prov$ (administrative) from $\tau_h$ (mechanism design); (CORP §5.1) definitions and Glossary entries for $\tau_h$ updated; (CORP §9.2) rewritten accordingly; (CORP.A (CORP §B.)1) and (CORP §B.2) revised with full derivations; formatter pass |
| 1.6      | 31 July 2026  | Consistency pass against CORP.A v1.6: Glossary $\tau_h$ entry, (CORP §5.1) $\tau_h$ definition, (CORP §5.3) tranche-three paragraph, and (CORP §5.9) $\tau_h$ calibration paragraph all updated to reflect (CORP §B.2) revised framework — legal proportionality replaced throughout with [deterrence floor, $\tau_m$] calibration range and self-defeating litigation observation; (CORP §6) extended with cross-reference to (CORP.A §F) for non-corporate instrument classification |
| 1.7      | 3 August 2026 | Formatter pass: temporal artifact removed from (CORP §5.3) ("rather than anti-arbitrage logic"); AI tell removed from (CORP §5.9) ("$\tau_h$ is a different question" pivot sentence); (CORP §9.1) temporal artifact removed ("previously treated as open") and AI-tell elaboration tightened; (CORP §9.2) AI tell tightened (competing-objectives list replaced with calibration range statement); GOV parenthetical stripped from (CORP §9.2) final sentence |
| 1.8 | 5 Aug 2026 | Structural revision: (CORP §9) (Conclusion) split into (CORP §9) (Limitations and Required Further Work) and (CORP §10) (Conclusion); resolved-design inventory moved to conclusion body; open questions content separated into limitations section. No substantive changes. |
| 1.9 | 8 Aug 2026 | Rewrote Limitations |
| 2.0 | 8 Aug 2026 | (CORP §2) extended with CIT and dividend tax distortions argument; (CORP §4.1) extended with thin trading, suspension/delisting, and dual-class share design rules; (CORP §5.3) updated with facility optionality forward reference; new (CORP §6) (Corporate Equity Settlement Facility) added; existing (CORP §6)–(CORP §9) renumbered (CORP §7)–(CORP §10); (CORP §9) Governing Council calibration parameters updated; (CORP §10) Conclusion updated; cross-references corrected |
...
The paper proceeds as follows. (CORP (CORP §2)) establishes why existing instruments are insufficient. (CORP (CORP §3)) derives the corporate instrument from the WDT's individual-centred logic. (CORP (CORP §4)) establishes the listed/private distinction and, in (CORP (CORP §4.1)), sets out design rules for IPOs, mergers, buybacks, thin trading, suspension and delisting, and dual-class share structures. (CORP (CORP §5)) specifies the levy in full: calculation, provisional levy, credit release, intermediary pass-through, and final settlement. (CORP (CORP §6)) describes the corporate equity settlement facility available as an alternative to cash settlement of the provisional levy. (CORP (CORP §7)) states the attribution test for institutional ownership. (CORP (CORP §8)) addresses derivatives and synthetic exposure. (CORP (CORP §9)) addresses limitations and required further work.
...
| Mechanism | Corporate withholding levy (§5)        | Individual WDT assessment             |
...
An identified intermediary appearing on the register pays $\tau_0$ as a provisional charge at the company level. Where the intermediary passes the attribution test in (CORP (CORP §6)), it runs its own client-level reconciliation directly with the tax authority rather than via the company's settlement account.
...
Derivatives and synthetic exposure raise related questions, addressed in (CORP (CORP §7).)

## 5.11 Fund Implications

The corporate levy generates no refund obligation and requires no dedicated reserve. Revenue from final-charge portions flows into the existing WDT structure. Credit release mechanics and worked illustrations are in (CORP.A (CORP (CORP §A)).)
...
Every identified holder that holds shares on behalf of, or in a manner indirectly affecting, persons other than itself falls within tranche two of (CORP (CORP §5).) The corporate instrument applies a single attribution test to all such holders: can the intermediary identify and attribute its underlying beneficiaries to a degree that supports individual WDT reconciliation? Where it can, downstream pass-through is available on the terms set out in (CORP (CORP §5.5).) Where it cannot, either because the underlying claim is not a proportional, individually-assessable interest in specific shares, or because the intermediary lacks the information to identify who holds what, $\tau_0$ is final at the company level.
...
(CORP.A (CORP §D)) classifies specific entity types against the attribution test. (CORP.A (CORP §F)) extends the attribution analysis to non-corporate instruments, including charitable vehicles, special purpose vehicles, trusts, family limited partnerships, life insurance wrappers, and carried interest structures, demonstrating that the attribution test and delta mechanic produce the correct outcome for each without requiring a special regime.
...
The exclusion of derivative holders from reconciliation is distinct from the attribution test applied to intermediaries in (CORP (CORP §7).) An institution failing that test is excluded because the human claim behind its holding is too diffuse or contingent to reconcile against an individual liability, despite the institution holding real shares. A derivative holder has no position at the corporate level at all; the attribution test does not apply.
...
Two items remain. Valuation methodology for derivative positions for individual WDT purposes, particularly where no liquid secondary market exists, is assigned to (VAL). The disclosure problem for counterparties held through opaque OTC structures is the same disclosure and information-exchange problem that applies to unidentified beneficial ownership generally, handled through the tranche structure in (CORP (CORP §5)) and not resolvable unilaterally.

The double-counting risk previously flagged in (VAL) is closed by this analysis. A derivative holder has no position in the corporate levy's reconciliation ledger; no double-count can arise. (VAL.A (CORP (CORP §G).)4) records this closure.
...
No items in this section. The rate calibration frameworks in (CORP (CORP §B.1)) and (CORP (CORP §B.2)) are complete at the analytical level; what remains is Phase One data and Governing Council decisions. Design questions for the corporate instrument are resolved at the conceptual level; what remains is calibration and legal analysis.
...
The intermediary floor level, all rate calibration items for $\tau_0$ and $\tau_h$, are Governing Council parameters under the Tier 1 process. (CORP (CORP §B.1))–(CORP (CORP §B.3)) provide the analytical foundations.

...
|:--------:|:----:|---------|
| 1.0 | 31 July 2026 | Initial version: Appendix A (Model Specification, §A.1–A.7) and Appendix B (Model Output, §B.1–B.5) compiled from 2006 Balanced model run at v6; formatter pass applied |
| 1.1 | 31 July 2026 | §A.2 extended with marginal cohort architecture explanation; §A.4 success definition corrected; §A.5 TCM growth path corrected; §A.6 coverage figures updated to current model run (2006 TCM coverage 41.3%; sweep range 32.0%–159.3%); known boundary-alignment bug in SSM/TCM capitalisation windows flagged; Appendix B replaced with current model output |
| 1.2 | 1 August 2026 | References added: Jordà et al. (2019) cited in §A.3 as source of UK equity total return series; HM Treasury (2024) PSS May 2024 Table 10 cited in §A.3 as source of 5.24% expenditure growth rate; external References section added |
| 1.3 | 13 August 2026 | Parameter update: $\tau_0$ lowered from 20% to 15%; §A.3 rate parameters updated; §A.6 coverage figures and window updated throughout; Appendix B replaced in full with 2026-08-13 model output (v6 run, 2007 Balanced scenario, N=33) |
| 1.4 | 15 August 2026 | Budget growth rate corrected from 5.24% to 4.51% (see JUR v1.8 §2.11); §A.3 budget constants updated; §A.6 coverage figures, window span, sweep range, and prose updated throughout; Appendix B replaced in full with 2026-08-15 model output (v7 run, 2007 Balanced scenario, N=29) |
...
The Statistical Pass converts that 73-row dataset into summary statistics: success rate across start years, variation by economic cycle, and distribution of key transition metrics. The success definition is in §A.4.
...
The coverage metrics in §B.2 and §B.3 (and the sweep table's SSM and TCM coverage columns) answer a specific question: what fraction of government expenditure could have been replaced by WDT revenue during the capitalisation period? This is narrower than the headline revenue figures in RATES §7.

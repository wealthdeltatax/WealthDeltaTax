...
| 0.2 | 03 August 2026 | §B.4.6 added: data architecture credential-issuance model; §B.4.7 added: privacy election binary disclosure and rate differential; §E.7 added: Custodian inflationary rotation mandate guidance |
| 0.3 | 8 Aug 2026 | Rewrote Limitations |
| 0.4 | 8 Aug 2026 | New §H added: corporate equity settlement facility mandate extension — two new Custodian exposure categories (secured corporate lending, distinct corporate equity portfolio), stewardship statement requirements, relationship to existing mandate architecture, five Governing Council calibration parameters; old §H Limitations renumbered §I; §I Governing Council calibration parameters updated; §I Phase One empirical unknowns updated with facility take-up observable |
| 0.5 | 9 August 2026 | §B.2 Allocator redesigned per GOV v2.7: appointment changed to either-chamber-proposes, T1 confirms; §B.2.2 cooling-off bar removed; §B.2.3 revised — no term limit, T2 removal with rebalancing cost on proposing chamber if successful, no cost on failed T2, resignation available at any point including between seat-burn and T2 vote; §B.2.4 reframed — publication requirement retained, primary function now stated as making synthesised inside knowledge available to DR rather than detecting captured recommendations; §B.2.5 added — Allocator as public figure |
| 0.6 | 10 Aug 2026 | Removed Limitations |
| 0.7 | 13 Aug 2026 | Correction pass: stale GOV section cross-references updated throughout following GOV v2.1 restructure — §A.1.3 GOV §7 → GOV §5.3; §A.3.3 GOV §7.2 → GOV §5.2; §A.3.5 GOV §6.2.3 → GOV §5.3; §A.3.6 GOV §6.3 → GOV §6.4; §B.1.1 GOV §10 → GOV §6.1; §B.3 GOV §8 → GOV §6.3; §B.4.4 stale open-question note replaced with settled-clause statement; §C.1 GOV §7 → GOV §5, GOV §7.2 → GOV §5.2; §C.4 GOV §6.2.3 → GOV §5.3; §C.5 GOV §6.2.2 → GOV §5.3; §C.6 GOV §6.2.2 → GOV §5.3; §D.3 GOV §7.3 → GOV §5.3; §E.1 GOV §8.3 → GOV §6.3; §E.2 GOV §8.3 → GOV §6.3; §E.3 GOV §8.8 → GOV §6.3; §E.5 GOV §8.3 → GOV §6.3; §E.6 GOV §8.4/§8.3 → GOV §6.3; §F.4 GOV §9.1 → GOV §7.2; §F.5 GOV §9.3 → GOV §5.3; §G opening GOV §10 → GOV §6.1; §G.1 GOV §10.3 → GOV.B §G.2; §G.2 GOV §10.3 → GOV.B §G.2; §G.4 stale GOV §8.7 cross-reference removed (self-referential); internal bibliography FM title corrected, ENV typo fixed, unclosed italics on BEHAV/CLOSE/POL/PHASE1/ENV corrected |
| 0.8 | 15 Aug 2026 | added Advisor Corps to §B.2.5 and custodian Inflation Rotation Mandate §E.7 |
...
This appendix is the operational specification for the institutions GOV derives and GOV.A examines. GOV §3–§4 establish why each body exists; §5 introduces them; §6–§10 cover the voting system, rebalancing mechanism, SWF, per-actor costs, and Route D auction at the level needed to establish structural properties. GOV.A §A covers eligibility and appointment in summary. GOV.B contains everything required to implement each section of GOV operationally, in GOV's order.
...
The Allocator's revised mandate requires embedded knowledge of TP's epistemic world — the private information about investment conditions, attribution feasibility, and compliance experience that published TP proposals do not fully capture. The personal adviser corps, specified in BEHAV §5, provides a structured institutional source for this intelligence that does not depend on the Allocator's personal relationships with individual TP members.
...
Operational detail of the Custodian's conduct (bond sizing, bridging facility mechanics, drawdown conditions, stewardship statement format) is in §E.
...
The dual-threshold pass rule in GOV §6.1 has two conditions. Condition one catches organised opposition: if enough voters actively oppose a proposal, it fails regardless of how many support it. Condition two catches thin support: if yays do not outnumber nays among those who actually voted, the proposal fails regardless of how few opposed it. A proposal must clear both; passing one does not compensate for failing the other.
...
The withdrawal option persists through Tier 2 escalation under Cases one and two in §C.3. A proposal reclassified to Tier 2 has not yet concluded; the proposing chamber retains the withdrawal option until the Tier 2 session itself concludes. Under Case three, withdrawal is not available for the reasons stated in §C.3.
...
The mandatory content includes: the fund's current solvency ratio and its supporting calculation; the aggregate refund liability outstanding; aggregate active bridging facility commitments; the fund's investment portfolio in sufficient detail to permit independent assessment of its composition and risk profile; the Custodian's current drawdown conditions as specified in §E.2, with any changes from the prior year's statement explicitly identified; the Custodian's assessment of the fund's long-term stability and any material risks to it; and the unit-holder count and aggregate unit value.
...
The linkage itself is structural, not discretionary. The Governing Council may determine how the foregone-benefit figure is calculated, what rounding or presentation conventions apply, and what accompanying context is provided. It may not determine whether the linkage fires, suppress the foregone-benefit figure when it is inconvenient, or present the two pieces of information on separate ballots at separate times. The linkage fires automatically as a condition of the proposal entering the queue, on the same terms as the Register disclosure in §F.2.
...
The architecture collapses the future-generations interest into the SWF's present, mechanically computed solvency ratio. A rule change projected to reduce future solvency capacity triggers the automatic-consequence chain specified in §E.1 immediately, using a number the system already tracks for unrelated actuarial reasons. No new instrument is required. No party is required to judge whether the projected reduction is serious enough to warrant a response; the solvency ratio projection is a mechanical output of the proposed change's parameters applied to the fund's current position.

The acknowledged limitation is stated in GOV §7.2 and is not repeated here: this mechanism covers the financial slice of the future-generations interest, not non-solvency institutional drift that would not move the actuarial ratio. That residual is addressed as an irreducible sub-form of governance decay in GOV.A §E.
...
The mapping across actor types: for TP and FS (patient wealth with a long-horizon governance interest) the cost axis is vote-share rebalancing (§F.1; full arithmetic in §D) and the visibility axis is the Public Valuation Register disclosure (§F.2), which makes the financial stake in a structural proposal legible at the moment it enters the public record. For diffuse citizens, no same-instant cost mechanism is available; the visibility axis operates through ballot linkage of the foregone benefit (§F.3). For future citizens, both axes collapse into the solvency ratio: the projected solvency impact is the cost (triggering §E.1 consequences automatically) and the published calculation is the visibility mechanism. The public register layers across all actor types are specified in GOV §5.3 and are not repeated here.

...
§3.2 derived DR's standing and fixed its vote share at 50% on structural (GOV §4) established that enumerated prohibitions are necessary but not sufficient: the discrete form of Mode B governance failure requires a mechanism-shaped response, not just a rule-shaped one.

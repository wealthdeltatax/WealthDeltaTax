...
The governing characterisation of the state/taxpayer relationship is reciprocal partnership, as settled in (GOV.A §E.5). The symmetric refund is its operational expression: the state accepts downside exposure alongside the taxpayer. Governance participation is its structural expression at the institutional level. (POL §5.7) notes that the cooperative architecture's political durability follows from the same derivation as its moral correctness — a consequence of the foundational axiom rather than a separate political calculation layered on top.

...
*2025/26 income tax and NICs rate schedules throughout (@HMRC2025c). Post-WDT take-home assumes zero income tax and zero employee NICs. Purchasing power equivalent adds VAT displacement (55% VAT-able spend) and energy bill reduction (30% SWF infrastructure reduction from £1,755 baseline (@Ofgem2025Oct)); see §4.4 for full methodology. Transport and communications infrastructure effects not included in purchasing power figure — directional only. Employer NICs displacement shown separately in §3.1.*
...
The table below assembles the channels from §2 and §4.1–4.3 for a median earner and a lower earner. Tax figures use 2025/26 rate schedules (@HMRC2025c) and April 2025 ONS earnings data (@ONS2025ASHE). The VAT figure assumes 55% of household consumption is VAT-able, consistent with ONS household expenditure composition (@ONS2025ETB). The energy figure uses a 30% reduction from the October 2025 Ofgem average (@Ofgem2025Oct). Both consumption figures are illustrative scenario estimates rather than modelled projections and are labelled accordingly.

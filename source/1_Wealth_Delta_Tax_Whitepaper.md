...
keywords:
    ...
    - Haig-Simons income
    - symmetric loss offset
    - Sovereign Wealth Fund
    - cooperative taxation
    - Harberger self-assessment
    - tax-base reform
...
Sweden [@Seim2017] finds modest behavioural response elasticities, but approximately one third of the measured response reflects underreporting rather than real changes in saving behaviour. Denmark [@JakobsenEtAl2020] finds larger responses at the very top of the distribution, but Denmark's strong third-party reporting regime limited evasion, so the measured response reflects portfolio reallocation rather than avoidance. Switzerland [@BrulhartEtAl2022] finds much larger elasticities, but this is attributable to decentralisation across cantons enabling within-country relocation, which is not transferable to a nationally administered system. Norway [@JakobsenEtAl2024] finds that following a 2022 wealth tax increase, migration responses were real but fiscally modest, with roughly 22 cents lost per unit of revenue raised, and that revenues continued to grow because the remaining base expanded. Colombia [@LondonoVelezAvilaMahecha2025] finds high elasticities driven primarily by underreporting of self-reported assets, while assets subject to third-party reporting showed minimal response.
...
@Piketty2014, @SaezZucman2016 and @SaezZucman2019 place the top 1% share of US household wealth at approximately 38%, with similar trends across developed capitalist democracies. These figures are contested on methodological grounds. @Kopczuk2015 and @BrickerEtAl2016 argue the capitalisation method overstates concentration. What is accepted across methodological approaches is the direction of the trend. Concentration has increased since the 1980s, and unrealised capital gains account for a growing share of top-end wealth.

@SaezZucman2019 proposal for a progressive annual wealth tax differs from the WDT in two respects: it taxes the stock of wealth rather than the annual change, and it contains no loss-refund mechanism. In a year of significant market decline, a stock-based wealth tax still generates a substantial liability on a wealth base that has fallen in value, potentially forcing asset sales at distressed prices. The WDT generates a refund in that scenario.

## 2.5 The Domar-Musgrave Principle

@DomarMusgrave1944 argued that tax systems with full loss offsets affect investment behaviour differently from systems that tax gains without equivalent relief. When gains and losses are treated symmetrically, the government absorbs a proportional share of both outcomes, reducing expected returns and variance at the same rate. For risk-averse investors, this can increase willingness to hold risky assets because after-tax volatility falls without a proportional reduction in expected return. Asymmetric systems impose a structural penalty on variance, creating a bias toward lower-risk allocation.

Symmetric loss treatment therefore makes the WDT less distortionary than asymmetric alternatives, not only more equitable. Founders, entrepreneurs, and holders of concentrated illiquid positions face lower effective penalties on variance after tax. The behavioural implications under progressive rates and a wealth rather than income base remain an open modelling question, identified in (WP §9.1).

A further efficiency argument operates through a different channel. Where returns on capital are heterogeneous across investors, wealth taxation reallocates capital toward higher-return uses by imposing a heavier relative burden on low-return holders. This reallocation effect does not depend on risk aversion or loss symmetry. @GuvenonEtAl2023 provide the formal treatment. Neither argument has been formally extended to a delta-based tax, and both are identified as modelling priorities in (WP §9.1).

## 2.6 Harberger Self-Assessment and the Purchase Option Tradition

The SWF's statutory option to acquire assets at taxpayer-submitted valuations draws on a body of literature not previously applied to wealth taxation. @Harberger1965 property tax proposal introduced the mechanism in its modern form. Property owners declare their own valuations, pay an annual levy on those declared values, and accept a standing obligation to sell at their declared price. Owners who declare low values to reduce tax risk losing the asset at that price. Owners who declare high values to protect against forced sale pay correspondingly higher tax. Under idealised conditions, self-reported values converge toward true market values without the state performing independent appraisal.

@PosnerWeyl2018 elaborated this in Radical Markets as a Common Ownership Self-Assessed Tax, identifying two core properties: the mechanism creates a credible deterrent to underreporting by making the under-reporter bear the cost of their own misstatement, and it generates allocative efficiency gains by ensuring assets flow to whoever values them most.
...
The first is valuation. No previous proposal fully implements an accrual-based Haig-Simons system while providing a workable approach to illiquid asset valuation. @Shakow1986 made the strongest theoretical case but acknowledged the problem without resolving it.
...
The WDT is inherently pro-cyclical: revenues rise in boom periods and fall, or turn negative, in downturns. That pro-cyclicality is one reason the Sovereign Wealth Fund is structurally important. The delta base also removes the lock-in distortion and the debt-preference incentive that realisation-based systems create, eliminating systematic pressure for capital to remain in its existing allocation regardless of productive merit. Both macroeconomic questions are identified in (WP §9.1).
...
The RATES framework establishes that at Balanced parameters ($\tau_0$ = 20%, $\tau_m$ = 70%, $k$ = 0.001 per £m, $W_{min}$ = £2m) calibrated to UK data, the WDT raises revenue in the appreciable tens of percent of government expenditure across the capitalisation window. Two figures bracket the plausible range: a floor of 21.3% (SSM, correlated-shock assumption) and a central estimate of 27.7% (TCM, heterogeneous tier differentials). These figures are drawn from the 2007 start year, deliberately the hardest illustrative case in the 73-year sweep, producing the longest LRR fill time (29 years) and therefore the most conservative revenue-to-expenditure ratio in the dataset. The best-case year (1974 start) produces a TCM coverage ratio of 134.5%; the median across all 73 start years is 40.3%. These are pre-behavioural figures; RATES is explicit that behavioural responses will reduce actual yield by an amount only Phase One can establish. The parameters are illustrative: different rate choices produce different fiscal replacement timelines, and the Governing Council holds that calibration. The full model specification and sensitivity sweep are in (RATES) and (RATES.A).

The deeper result is structural rather than parametric. The SSM models UK budget expenditure growing at 4.51% per annum derived from 1999–2019 historical data. Private wealth in the UK has historically grown faster than that rate, which means that under any calibration sufficient to generate meaningful WDT revenue, the LRR will eventually fill, given enough time, if the historical growth pattern holds. RATES reframes fiscal replacement accordingly: not whether the WDT can fund government at scale, but when, contingent on the growth pattern and the rate calibration chosen. The 100% success rate across all 73 start years at Balanced parameters, including all four economic cycles in the dataset, is the evidence base for that claim (RATES.A §B.4) to (RATES.A §B.5). SRR fill, which makes the refund guarantee mechanically credible, is invariant at year 3 across all start years. LRR fill ranges from 7 to 29 years (median 13).

Revenue volatility is the most significant structural difference from existing instruments. The WDT is pro-cyclical by construction, high in periods of strong asset growth and low or negative in downturns, which is why the SWF contribution rules are designed to build reserves in good years rather than treating surplus as general fiscal headroom. The maximum annual wealth burden across the modelled population is 0.98% of net worth. This figure applies only to a taxpayer reaching a terminal net worth of approximately £1.7bn after 29 years of sustained annual growth of 13.9%, placing them simultaneously at the top of both the wealth distribution and the persistent-growth distribution; it is not a typical or representative burden. The maximum effective rate on gains is 22.4% as a lifetime average including loss years with refunds. For most taxpayers the burden is a fraction of a percent because the base is the annual increment and the symmetric refund offsets loss years. The macroeconomic questions, covering pro-cyclicality effects, capital formation, aggregate demand effects of refunds, and pre-commitment versus discretionary crisis response, are identified in (WP §9.1).
...
The Domar-Musgrave variance-reduction result establishes that symmetric government participation in investment outcomes reduces portfolio distortions, but only for flat-rate income taxation with loss offsets. Extension to a progressive, delta-based wealth tax requires separate treatment of three complications: a net-worth rather than asset-return base, progressive marginal rates, and multi-period asymmetry between gain-year and loss-year applicable rates. The formal welfare comparison between a delta-based system and the consumption tax alternative has similarly not been done. The directional claims the WDT makes about both are well-grounded; the formal proofs are not yet available.
...
The revenue figures in (WP §5) are pre-behavioural and derived from a cohort model rather than microsimulation on administrative records. Migration, restructuring, and avoidance will reduce actual revenue by an amount only Phase One implementation can establish. They are an upper-bound starting point, not an expected outcome.
...
The RATES modelling addresses this directly. The 100% success rate across 73 historical start years, including all four economic cycles, is the evidence base for the claim that the base is robust under realistic stress. But that result is pre-behavioural. Migration, restructuring, and the cross-base fiscal externality identified by @AgrawalEtAl2025 — under which wealth-tax-driven departure generates income tax and VAT losses substantially larger than the direct revenue loss — all operate on the narrow taxable population in ways the historical equity return data does not capture. (BEHAV §9.2) develops the six-part response to the externality; the Phase One magnitude is unknown.

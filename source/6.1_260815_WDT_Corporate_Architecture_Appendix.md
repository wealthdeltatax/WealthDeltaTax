...
| $\tau_f$ | $\tau_F$ diplomatic rate-setting (bilateral/multilateral agreement; not a WDT parameter). Ceiling on unattributable ownership by foreign companies of WDT jusrisdiciton assets |

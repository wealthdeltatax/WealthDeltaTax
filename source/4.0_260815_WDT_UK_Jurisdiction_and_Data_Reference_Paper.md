...
**Budget growth rate correction (audit record).** The TOML parameter `budget_growth` previously read 0.0524 (4.51%), with a comment attributing this to "UK historical public expenditure 1999–2019." An audit against PSS_May_2024_TES_UPDATED.xlsx Table 10 established that no pre-COVID window of nominal TME data ending in 2019–20 produces 4.51%; the correct pre-COVID figure for the stated window (1999–00 to 2019–20, n = 20) is 4.51%. The figure 4.51% is reproduced only from a window whose terminal year is 2020–21, inflated by COVID-19 emergency spending. The corrected value of 4.51% is used in all model runs from RATES v[next] onward. The direction of the correction is conservative-weakening: the smaller denominator raises coverage ratios relative to prior figures. No design position is affected; this is a data-source clarification only. Full derivation is in (JUR §2.11).

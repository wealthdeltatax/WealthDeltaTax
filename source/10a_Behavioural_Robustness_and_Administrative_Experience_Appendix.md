...
This section contains the full seven-part response to the @AgrawalEtAl2025 cross-base externality finding. The headline framing — the WDT is not a stock wealth tax; the Agrawal direction of effect is likely to apply but the magnitude is unknown; and membrane investment is fiscally urgent at a six-to-one multiplier — is in (BEHAV §9.2). What follows supplements that framing with the remaining analytical responses.

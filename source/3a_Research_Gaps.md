...
Closing this gap requires technical work specifying how the minimum-tax standard is measured against a refund-based system and whether the modifications needed to accommodate it are compatible with the floor's anti-avoidance objectives. This is separable from the political question of whether coordination is achievable (LR.A §4.2) and from the design question of what exit provisions the WDT should carry addressed in (CLOSE). This gap is classified in (SCOPE §2).
...
| # | Gap | Verdict | What closing it requires | SCOPE |
|---|---|---|---|---|
...
| 2 | Welfare comparison including a delta-based wealth tax | Confirmed — closed by WFR | Extension of the @GuvenonEtAl2023 use-it-or-lose-it model to a delta base, or an independent welfare comparison model; six-system revenue-equivalent comparison in (WFR §3–§4); live dispute with @BoadwaySpiritusEtAl2025 engaged in (WFR §5.5) | — |
...
| 4 | Cooperative compliance effects at the ultra-high-net-worth level | Confirmed — open | Studies designed around the institutional structure of compliance decision-making in professionally mediated high-wealth networks | §3.1 |
| 5 | Cross-base migration externality in behavioural modelling | Confirmed — open | Modelling framework that incorporates the @AgrawalEtAl2025 finding into integrated cross-base revenue projections | §3.1 |
| 6 | Administrative-layer intervention effects on compliance psychology | Confirmed — open | Experimental or natural experiment evidence on specific administrative communication features; partly Phase One dependent but independently addressable as a literature gap | §3.1 |
| 7 | Causal framework for wealth tax abolition | Confirmed — open | Independent derivation and validation through formal political economy model or comparative case study evidence | §2 |
| 8 | International competitive dynamic at the political level | Confirmed — open | Political economy modelling of how economic mobility effects transmit through domestic institutional channels over time | §2 |
| 9 | Minimum-tax interaction with refund-based systems | Confirmed — open | Technical specification of how a minimum-tax standard applies to a system generating negative tax in loss years | §2 |

These nine gaps do not undermine the case for the WDT. They are the agenda for the next phase of formal work: some modelling tasks that can proceed now, some requiring implementation data, and some requiring coordination between the WDT project and emerging international policy processes. The SCOPE column gives the section of (SCOPE) where each open gap is classified and its resolution path recorded; gaps closed by WFR have no SCOPE entry.

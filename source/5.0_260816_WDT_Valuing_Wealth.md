...
See (VAL.B §L) and (VAL.B §M) for the failure case and Route D entry basis vulnerability respectively.
...
The full governance design, including the non-discretionary trigger, the three-body Valuation Body architecture, Clause 8 of the enumerated structural list, and what remains open for Phase One calibration, is in (GOV.B §G).

...
| $\tau_f$ | τ_f diplomatic rate-setting (bilateral/multilateral agreement; not a WDT parameter). Ceiling on unattributable ownership by foreign companies of WDT jusrisdiciton assets | Phase 1 Diplomatic calibration parameter |

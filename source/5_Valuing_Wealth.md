...
| 1.09 | 25 September 2026 | Crosslinks updated to reflect closure bond facility generalisation and expanded inheritance mechanics: glossary hard basis reset entry extended with death auction waiver pointer to (CLOSE §4.1.1); §6.4 extended with death auction waiver pointer; §6.5 extended with forward pointer to (CLOSE §4.1) as sequencing authority for death closure; §11.5 extended with death auction waiver pointer; §13 bridging facility reference updated to closure bond facility (CLOSE §5); §14.3 extended with forward pointer to (CLOSE §4.1) for full death settlement sequence |
...
A hard basis reset performed sufficiently recently before death may qualify for the death auction waiver under the Governing Council's threshold parameter, eliminating the inheritance auction requirement at death and establishing the reset price directly as the Route D component of W_death. A soft reset does not qualify regardless of recency. The waiver conditions and threshold parameter are specified in (CLOSE §4.1.1).
...
Inheritance is the point at which the voluntary option becomes compulsory. The process is identical; the trigger differs. Where a qualifying hard reset occurred within the Governing Council's death auction waiver threshold period, the inheritance auction may be waived and the reset price used directly as the Route D component of W_death; see (CLOSE §4.1.1).

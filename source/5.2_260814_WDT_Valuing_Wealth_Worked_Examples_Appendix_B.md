...
The Route D auction mechanism (VAL §11), (GOV.B §G) remains available as a backstop if the soft basis reset declared value is egregious relative to market evidence — the deterrent that makes the soft reset credible rather than a strategic minimum.
...
| **§M: Voluntary settlement** | Soft/hard resets give certainty, not avoidance | Liability paid in full at declared or market value; basis resets for all future calculations | (VAL §6.4); (GOV.B §G) |
